    ...
    <div className='w-full flex flex-col items-center'>
      <div className='animate-in flex flex-col gap-14 opacity-0 max-w-7xl px-3 py-16 lg:py-24 text-foreground'>
        ...
        <div className='flex flex-col gap-8 text-foreground'>
          ...
          {todayDeals.length == 0 && (
            <div className='text-foreground text-center'>
              <p className='inline-flex items-center justify-center'>No {today} only deals <Frown className='ml-2'/></p>
            </div>
          )}
        </div>
        ...
        <div className='flex flex-col gap-8 text-foreground'>
          ...
          {happyHourDeals.length == 0 && (
            <div className='text-foreground text-center'>
              <p className='inline-flex items-center justify-center'>No happy hour deals <Frown className='ml-2'/></p>
            </div>
          )}
        </div>
        ...
        <div className='flex flex-col gap-8 text-foreground'>
          ...
          {everydayDeals.length == 0 && (
            <div className='text-foreground text-center'>
              <p className='inline-flex items-center justify-center'>No every day deals found in your city  <Frown className='ml-2'/></p>
            </div>
          )}
        </div>
      </div>
